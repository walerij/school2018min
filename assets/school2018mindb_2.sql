...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 08 2018 г., 07:13
...
) ENGINE=InnoDB AUTO_INCREMENT=3832 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

--
-- Дамп данных таблицы `access`
--

INSERT INTO `access` (`id`, `pupil_id`, `payment_id`, `packet`, `status`, `access_from`, `access_till`, `info`, `bonus_till`) VALUES
(3830, 1, 1, 'game2', 'open', '2018-03-05', '2018-04-30', '', NULL),
(3831, 1, 1, 'soft1', 'open', '2018-03-04', '2018-06-04', '', NULL);
